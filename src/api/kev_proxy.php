<?php
// Simple proxy to fetch KEV API server-side to avoid CORS issues.
// Usage: api/kev_proxy.php?cve=CVE-YYYY-NNNN
...
$remote = 'https://kevin.gtfkd.com/kev/exists?cve=' . urlencode($cve);
