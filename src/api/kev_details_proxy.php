<?php
// Simple proxy to fetch KEV details API server-side to avoid CORS issues.
// Usage: api/kev_details_proxy.php?cve=CVE-YYYY-NNNN
...
$remote = 'https://kevin.gtfkd.com/kev/' . urlencode($cve);
...
// Try to pass the body through. KEV API returns JSON; echo as-is.
